import { AfterViewInit, EventEmitter, OnInit, ChangeDetectorRef } from '@angular/core';
...
export declare class MapComponentComponent implements OnInit, AfterViewInit {
    ...
    view: any;
    constructor(reportService: ReporterService, geoService: GeographicService, dialog: MatDialog, _ref: ChangeDetectorRef);
    private initDrawTool;
    private canSetBounding;
    private initMap;
    ngAfterViewInit(): void;
    resetView(): void;
    setView(bounding?: L.LatLngBounds): void;
